...
public class In {
     ...
     * @deprecated Clearer to use {@link solution.graph.StdIn#readAllInts()}
     */
     ...
     * @deprecated Clearer to use {@link solution.graph.StdIn#readAllDoubles()}
     */
     ...
     * @deprecated Clearer to use {@link solution.graph.StdIn#readAllStrings()}
     */
